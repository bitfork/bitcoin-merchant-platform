 ...
 */
class WobCurrency extends WobActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, code, round, create_date, mod_date', 'required'),
			array('round, is_pay, is_active', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>256),
			array('code', 'length', 'max'=>5),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, code, round, is_pay, is_active, create_date, mod_date', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return WobCurrency the static model class
	 */
